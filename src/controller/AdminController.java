...
public class AdminController {
    ...
    public static void addCar(String[] words, int i) {
        ...
        Car car = new Car(name, price, category, numOfInventory,0, companyName, engineCapacity, automatic);
    ...
    public static void addBike(String[] words, int i) {
        ...
        Bike bike = new Bike(name, price, category, numOfInventory, 0,companyName, type);
    ...
    public static void addFood(String[] words, int i) {
        ...
        Food food = new Food(name, price, category, numOfInventory,0, productionDate, expirationDate);
    ...
    public static void addSSD(String[] words, int i) {
        ...
        SSD ssd = new SSD(name, price, category, weight, dimensions, capacity, numOfInventory,0, readingSpeed, writingSpeed);
    ...
    public static void addNoteBook(String[] words, int i) {
        ...
        NoteBook noteBook = new NoteBook(name, price, category, numOfInventory,0, country, paperNum, paperType);
    ...
    public static void addPen(String[] words, int i) {
        ...
        Pen pen = new Pen(name, price, category, numOfInventory,0, country, color);
    ...
    public static void addPencil(String[] words, int i) {
        ...
        Pencil pencil = new Pencil(name, price, category, numOfInventory,0, country, pencilCategory);
    ...
    public static void addUSB(String[] words, int i) {
        ...
        USB usb = new USB(name, price, category, numOfInventory,0, weight, dimensions, capacity, version);
    ...
    public static void addComputer(String[] words, int i) {
        ...
        PersonalComputer computer = new PersonalComputer(name, price, category, numOfInventory,0, weight, dimensions, CPUModel, RAMCapacity);
